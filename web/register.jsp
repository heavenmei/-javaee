                    ...
                    <div class="form-bottom" >
                        <form role="form" action="useregister.action" method="post" class="registration-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" name="pu.phone" placeholder="电话号码" class="form-email form-control" id="form-email1">
                            </div>
                            <div class="form-group">
                            ...
                            <button onclick="location.href='search.jsp'" type="submit" class="btn">返回主页</button>
                        </form>
                    </div>
