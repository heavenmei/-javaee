                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <c:forEach var="x" items="${sessionScope.AllHotel }">
                                                <tr>
                                                    <td>${x.getHotelId() }</td>
...
<%--</c:forEach>--%>
<%--<c:choose>--%>
<%--<c:when test="${sessionScope.user.getUseridentity() eq '管理员' }">--%>
<%--<tr><td><a href="operator2.jsp">back</a></td></tr></c:when>--%>
<%--<c:otherwise>--%>
<%--<tr><td><a href="addHotel.jsp">back</a></td></tr>--%>
<%--</c:otherwise>--%>
<%--</c:choose>--%>
<%--</table>--%>
</body>
