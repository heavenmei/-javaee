...
<%--<table>--%>
<%--<tr><td><a href="addHotel.jsp"><input type="button" value="添加旅店"></a></td></tr>--%>
<%--<tr><td><a href="MyHotel.action"><input type="button" value="我的旅店"></a></td></tr>--%>
<%--<tr><td><a href="showB.action"><input type="button" value="我的订单"></a></td></tr>--%>
<%--<tr><td><a href="showBH.action"><input type="button" value="历史订单"></a></td></tr>--%>
<%--</table>--%>
</body>
</html>