                ...
                <div class="section-body">
                    <div class="row">
                        <div class="col-lg-5 col-md-12 col-12 col-sm-12">
                            <form action="addHotel.action" method="post" class="needs-validation" novalidate>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label><h5>旅店名字：</h5></label>
                                            <input type="text" name="ph.hotelname" class="form-control" required>
                                            <div class="invalid-feedback">
                                                Please fill in the title
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label><h5>所在城市：</h5></label>
                                            <input type="text" name="ph.area" class="form-control" required>
                                            <div class="invalid-feedback">
                                                Please fill in the title
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label><h5>所在区域：</h5></label>
                                            <input type="text" name="ph.place" class="form-control" required>
                                            <div class="invalid-feedback">
                                                Please fill in the title
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label><h5>电话号码：</h5></label>
                                            <input type="tel" name="ph.phone" class="form-control" required>
                                            <div class="invalid-feedback">
                                                Please fill in the title
                                            </div>
                                        </div>
...
<%--<form action="addHotel.action" method="post">--%>
<%--<table>--%>
<%--<tr><td>旅店名:</td><td><input type="text" name="ph.hotelname"></td></tr>--%>
<%--<tr><td>区域:</td><td><input type="text" name="ph.area"></td></tr>--%>
<%--<tr><td>place:</td><td><input type="text" name="ph.place"></td></tr>--%>
<%--<tr><td>电话号:</td><td><input type="tel" name="ph.phone"></td></tr>--%>
<%--<tr><td><input type="submit" value="添加"></td><td><a href="operator.jsp">back</a></tr>--%>
<%--</table>--%>
<%--</form>--%>
