...
<%--                                                <th> </th>--%>
                                            ...
                                            <c:forEach var="x" items="${sessionScope.SOrder }">
                                                <c:choose>
                                                    <c:when test="${x.getStatu() eq '已预订' }"></c:when>
                                                    <c:otherwise>
                                                        <tr>
                                                            <td>${x.getOid() }</td>
                                                            ...
                                                            <td><div class="badge badge-danger">${x.getStatu() }</div></td>
<%--                                                            <td><a href="confirm.action?qoid=${x.getOid() }"><input type="button" value="确认"></a></td></tr>--%>
                                                        </tr>
                                                    </c:otherwise>
                                                </c:choose>
                                            </c:forEach>
...
<%--<td>${x.getOrderTime() }</td><td>${x.getStatu() }</td></tr>--%>
<%--</c:otherwise>--%>
<%--</c:choose>--%>
<%--</c:forEach>--%>
