                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <c:forEach var="x" items="${sessionScope.delresult }">
                                                <tr>
                                                    <td>${x.getHotelId() }</td>
                                                    ...
                                                    <td>${x.getPhone() }</td>
                                                    <td>${x.getOwner() }</td>
                                                    <td><a href="delhotel.action?dhid=${x.getHotelId() }"><input type="button" value="删除"></a></td>
                                                </tr>
                                            </c:forEach>
                                        </table>
                                    </div>
...
<%--<form action="selectDel" method="post">--%>
<%--<table>--%>
<%--<tr>--%>
<%--<td><input type="text" name="hname"></td>--%>
<%--<td><input type="submit" value="查询"></td>--%>
<%--&lt;%&ndash;<td><a href="operator2.jsp">back</a></tr>&ndash;%&gt;--%>
<%--</table>--%>
<%--</form>--%>
<%--<table>--%>
<%--<c:forEach var="x" items="${sessionScope.delresult }">--%>
