...
<%--<table>--%>
<%--<tr><td><a href="register.jsp"><input type="button" value="注册用户"></a></td></tr>--%>
<%--<tr><td><a href="AllUser.action"><input type="button" value="所有用户"></a></td></tr>--%>
<%--<tr><td><a href="updateUser.jsp"><input type="button" value="修改用户"></a></td></tr>--%>
<%--<tr><td><a href="allhotel.action"><input type="button" value="所有旅店"></a></td></tr>--%>
<%--<tr><td><a href="delHotel.jsp"><input type="button" value="删除旅店"></a></td></tr>--%>
<%--</table>--%>
